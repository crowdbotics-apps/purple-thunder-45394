"""
Django settings for purple_thunder_45394 project.
...
ROOT_URLCONF = 'purple_thunder_45394.urls'
...
WSGI_APPLICATION = 'purple_thunder_45394.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "purple_thunder_45394 API",
    "DESCRIPTION": "API documentation for purple_thunder_45394 App",
    "VERSION": "v1",
}
